...
trait DriverNotify
{
    public static function notifyToDriver(){
        return [
            ...
            'kycUnverified'         => 'Kyc Unverified Drivers',
            'kycVerified'           => 'Kyc Verified Drivers',
            'kycPending'            => 'Kyc Pending Drivers',
            ...
            'pendingTicketUser'     => 'Pending Ticket Drivers',
            'answerTicketUser'      => 'Answer Ticket Drivers',
            'closedTicketUser'      => 'Closed Ticket Drivers',
